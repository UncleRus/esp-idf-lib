...
#define HELPER_IS_ESP32     (1)
#define HELPER_IS_ESP8266   (0)
...
#define HELPER_IS_ESP32     (0)
#define HELPER_IS_ESP8266   (1)
#else
#error BUG: cannot determine the target
#endif

/*  {{{ post-tests  */
#if HELPER_IS_ESP32 == 1 && HELPER_IS_ESP8266 == 1
#error BUG: HELPER_IS_ESP32 == 1 && HELPER_IS_ESP8266 == 1
#endif

#if HELPER_IS_ESP32 && HELPER_IS_ESP8266
#error BUG: HELPER_IS_ESP32 && HELPER_IS_ESP8266
#endif

#if HELPER_IS_ESP32 == 0 && HELPER_IS_ESP8266 == 0
#error BUG: HELPER_IS_ESP32 == 0 && HELPER_IS_ESP8266 == 0
#endif
...
#if HELPER_IS_ESP32 && HELPER_TARGET_VERSION >= HELPER_TARGET_VERSION_ESP8266_V0
#error HELPER_IS_ESP32 is true but HELPER_TARGET_VERSION  >= HELPER_TARGET_VERSION_ESP8266_V0
#endif

#if HELPER_IS_ESP8266 && HELPER_TARGET_VERSION < HELPER_TARGET_VERSION_ESP8266_V0
#error HELPER_IS_ESP8266 is true but HELPER_TARGET_VERSION < HELPER_TARGET_VERSION_ESP8266_V0
#endif
/* }}} */
